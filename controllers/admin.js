...
exports.createPostPostController = async (req, res)=>{
  const {title, description, address, apartment_size, road_size, parking, land_size, units, floors, handover_time} = req.body;
  ...
  let sql = `insert into projects (title, description, thumbnail, gallery, post_images, address, apartment_size, road_size, parking, land_size, units, floors, handover_time) values('${title}', '${$('body').html()}', '${thumbnail}', '${JSON.stringify(projectImagesUrl)}', '${JSON.stringify(postImages)}', '${address}', '${apartment_size}', '${road_size}', '${parking}', '${land_size}', '${units}', '${floors}', '${handover_time}')`;
  ...
  if(edit && thumbnail.length > 0 && projectImagesUrl.length > 0){
    sql = `update projects set title='${title}', description='${$('body').html()}', thumbnail='${thumbnail}', gallery='${JSON.stringify(projectImagesUrl)}', post_images='${JSON.stringify(postImages)}', address='${address}', apartment_size='${apartment_size}', road_size='${road_size}', parking='${parking}', land_size='${land_size}', units='${units}', floors='${floors}', handover_time='${handover_time}' where id=${id}`
  }else if(edit && thumbnail.length > 0){
    sql = `update projects set title='${title}', description='${$('body').html()}', thumbnail='${thumbnail}', post_images='${JSON.stringify(postImages)}', address='${address}', apartment_size='${apartment_size}', road_size='${road_size}', parking='${parking}', land_size='${land_size}', units='${units}', floors='${floors}', handover_time='${handover_time}' where id=${id}`
  }else if(edit && projectImagesUrl.length > 0){
    sql = `update projects set title='${title}', description='${$('body').html()}', gallery='${JSON.stringify(projectImagesUrl)}', post_images='${JSON.stringify(postImages)}', address='${address}', apartment_size='${apartment_size}', road_size='${road_size}', parking='${parking}', land_size='${land_size}', units='${units}', floors='${floors}', handover_time='${handover_time}' where id=${id}`
  }else if(edit){
    sql = `update projects set title='${title}', description='${$('body').html()}', post_images='${JSON.stringify(postImages)}', address='${address}', apartment_size='${apartment_size}', road_size='${road_size}', parking='${parking}', land_size='${land_size}', units='${units}', floors='${floors}', handover_time='${handover_time}' where id=${id}`
  }
